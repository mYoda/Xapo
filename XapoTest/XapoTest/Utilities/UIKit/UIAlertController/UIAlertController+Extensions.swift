...
extension UIAlertController {
    ...
    /**
     ...
     - parameter title: The text to use for the action title.
     - parameter icon: The icon to use for the action item.
     - parameter alignment: Action item content alignment.
     - parameter style: The style to use for the action (optional, defaults to `.default`).
     - parameter handler: A closure to execute when the user selects the action (optional, defaults to `nil`).
     ...
     */
    @discardableResult
    public func addAction(title: String, icon: UIImage?, alignment: CATextLayerAlignmentMode = .left, style: UIAlertAction.Style = .default, handler: ((UIAlertAction) -> Void)? = nil) -> Self {
    ...
    /**
     Adds a UIAlertAction, initialized with a title, icon, style, and completion handler.

     - parameter title: The text to use for the action title.
     - parameter systemIcon: The system icon name to use for the action item.
     - parameter alignment: Action item content alignment.
     - parameter style: The style to use for the action (optional, defaults to `.default`).
     - parameter handler: A closure to execute when the user selects the action (optional, defaults to `nil`).
     ...
     */
    @discardableResult
    public func addAction(title: String, systemIcon: String, alignment: CATextLayerAlignmentMode = .left, style: UIAlertAction.Style = .default, handler: ((UIAlertAction) -> Void)? = nil) -> Self {
        let action = UIAlertAction(title: title, style: style, handler: handler)
        addAction(action)
        action.setValue(alignment, forKey: "titleTextAlignment")
        action.setValue(UIImage(systemName: systemIcon), forKey: "image")
        return self
    }
